...
import img1 from '../assets/frontend_assets/p_img2_1.png';
import img2 from '../assets/frontend_assets/p_img8.png';
import img3 from '../assets/frontend_assets/p_img7.png';
import img4 from '../assets/frontend_assets/p_img12.png';
...
export const MenPage = () => {
  ...
  return (
    <div className="container py-5">
      <h2 className="text-center mb-4">Men's Wear</h2>
